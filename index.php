...
<div id="news-updates">
	...
	if($counter == 1){
		?> <div class="news-article first-child"> <?php
	}else{
		?> <div class="news-article"> <?php
	}
	?>
	<h3><a href="news.php?id=<?php echo$news['id']; ?>"> <?php echo $news['title']; ?> </a></h3>
		<div class="by-line">
		by <a href="<?php echo $news['authorlnk']; ?>"><?php echo $news['author']; ?></a><span class="spacer"> //</span> <?php echo $news['date']; ?>
		<a href="news.php?id=<?php echo$news['id']; ?>#comments" class="comments-link"><?php echo $news['comments']; ?></a>
		</div>
		
		<div class="article-left" style="background-image: url('news/<?php echo $news['image']; ?>.jpg');">
		<a href="#"><img src="wow/static/images/homepage/thumb-frame.gif" alt="" /></a>
		</div>

        <div class="article-right">
			<div class="article-summary">
			<p><?php echo substr($news['content'],0,120)."..."; ?></p>
			<a href="news.php?id=<?php echo$news['id']; ?>" class="more">More</a>
            </div>
        </div>
	<span class="clear"><!-- --></span>
    </div>
